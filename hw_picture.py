...
cmd_run('title Happy Wheels Picture Level Data Generator')
cmd_run('color 0a')
cmd_run('cls')
...
try:
    ...
    try:
        ...
        if input('Pillow is not installed. Install it? [y/n]: ')=='y':
            ...
            cmd_run('python -m pip install Pillow')
            exit()
        else:
    ...
    try:
        ...
        if input('Themed tk is not installed. Install it? [y/n]: ')=='y':
            ...
            cmd_run('python -m pip install ttkthemes')
            exit()
        else:
            log('Download Canceled, Exiting...')
            exit()
    ...
    try:
        ...
        if input('TKinter is not installed. Install it? [y/n]: ')=='y':
            ...
            cmd_run('python -m pip install tk')
            exit()
        else:
            log('Download Canceled, Exiting...')
            exit()
